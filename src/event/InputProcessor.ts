import { Component, Vec2, RichText, sys, Node, Touch, Event, EventMouse, EventTouch, director, Vec3, ccenum, game, v3, v2 } from "cc";
...
export class InputProcessor extends Component {
    ...
    private touchEndHandler(evt: EventTouch): void {
        ...
        let evt2 = this.getEvent(ti, ti.target, FUIEvent.TOUCH_END, false, cocosPos);
    ...
    private getEvent(ti: TouchInfo, target: GObject, type: string, bubbles: boolean, cocosPos?: Vec2): FUIEvent {
