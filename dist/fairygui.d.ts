...
declare module 'fairygui-cc' {
    ...
    export { Event as FUIEvent } from "fairygui-cc/event/Event";
...
declare module 'fairygui-cc/GRoot' {
    import { Vec2, AudioClip, Node as ccNode } from "cc";
    ...
    export class GRoot extends GComponent {
        ...
        static create(uiRoot: ccNode): GRoot;
        constructor();
        protected onDestroy(): void;
...
declare module 'fairygui-cc/GRichTextField' {
    import { HorizontalTextAlignment, RichText, SpriteAtlas, SpriteFrame, VerticalTextAlignment } from "cc";
